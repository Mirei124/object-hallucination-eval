...
class Chat:
    def __init__(self, model="", timeout_sec=20, openai_apikey='', openai_baseurl="https://api.openai.com/v1"):
        self.model = model
        self.timeout = timeout_sec
        self.client = OpenAI(api_key=openai_apikey, base_url=openai_baseurl)
