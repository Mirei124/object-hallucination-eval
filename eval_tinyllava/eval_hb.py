...
def evaluate_by_chatgpt(
    data, output_entry, correctness_entry, gpt_model="gpt-4", load_json=False, save_json_path="./hallusion_output.json"
):
...
def check_same_by_chatgpt(
    data, output_entry, gpt_model="gpt-4", load_json=False, save_json_path="./hallusion_output.json"
):
    orig_response = {}
...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_file_name", help="answer file name")
    parser.add_argument("--load_json", action="store_true")
    parser.add_argument("--api_key")
    parser.add_argument("--api_base", default="https://api.openai.com/v1")
    parser.add_argument("--save_json_path_vd", default="./hallusion_output_vd_model.json")
    parser.add_argument("--save_json_path_vs", default="./hallusion_output_vs_model.json")
    parser.add_argument("--model_output_entry", default="model_prediction")
    parser.add_argument("--model_correctness_entry", default="gpt4v_output_gpt_check")
    args = parser.parse_args()
    input_file_name = args.input_file_name
    model_output_entry = args.model_output_entry
    model_correctness_entry = args.model_correctness_entry
    ...
    data_vd = evaluate_by_chatgpt(
        data_vd, model_output_entry, model_correctness_entry, load_json=load_json, save_json_path=save_json_path_vd
    )
